...
resource "aws_cloudwatch_dashboard" "aurora_postgres_dashboard" {
  dashboard_name = "aurora-postgres-dashboard"
    ...
    widgets = [
      {
        ...
        properties = {
          metrics = [
            ["AWS/RDS", "ReadIOPS", "DBClusterIdentifier", aws_rds_cluster.aurora_postgres_cluster.cluster_identifier],
            ["AWS/RDS", "WriteIOPS", "DBClusterIdentifier", aws_rds_cluster.aurora_postgres_cluster.cluster_identifier]
          ]
          period = 300
          stat   = "Average"
          region = "us-east-1"
          title  = "Aurora PostgreSQL - Read/Write IOPS"
          yAxis = {
            left = {
              min = 0
            }
      ...
      },
      {
        ...
        properties = {
          metrics = [
            ["AWS/RDS", "CPUUtilization", "DBClusterIdentifier", aws_rds_cluster.aurora_postgres_cluster.cluster_identifier],
            ["AWS/RDS", "DatabaseConnections", "DBClusterIdentifier", aws_rds_cluster.aurora_postgres_cluster.cluster_identifier]
          ]
          period = 300
          stat   = "Average"
          region = "us-east-1"
          title  = "Aurora PostgreSQL - CPU & Connections"
        }
      },
      {
        type   = "metric"
        ...
        properties = {
          metrics = [
            ["AWS/RDS", "ReadLatency", "DBClusterIdentifier", aws_rds_cluster.aurora_postgres_cluster.cluster_identifier],
            ["AWS/RDS", "WriteLatency", "DBClusterIdentifier", aws_rds_cluster.aurora_postgres_cluster.cluster_identifier]
          ]
          period = 300
          stat   = "Average"
          region = "us-east-1"
          title  = "Aurora PostgreSQL - Read/Write Latency"
        }
      },
      {
        type   = "metric"
        ...
        properties = {
          metrics = [
            ["AWS/RDS", "FreeableMemory", "DBClusterIdentifier", aws_rds_cluster.aurora_postgres_cluster.cluster_identifier],
            ["AWS/RDS", "SwapUsage", "DBClusterIdentifier", aws_rds_cluster.aurora_postgres_cluster.cluster_identifier]
          ]
          period = 300
          stat   = "Average"
          region = "us-east-1"
          title  = "Aurora PostgreSQL - Memory Usage"
        }
      }
    ]
  })
...
output "dashboard_url" {
  value = "https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#dashboards:name=${aws_cloudwatch_dashboard.aurora_postgres_dashboard.dashboard_name}"
}